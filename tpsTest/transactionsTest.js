var testPrivateAllFour = async function() {
  const Web3 = require('../app/node_modules/web3');

  let web3_2 = new Web3();
  let web3_3 = new Web3();
  let web3_4 = new Web3();

  await web3_2.setProvider(new Web3.providers.HttpProvider('http://192.168.1.121:22004'));
  await web3_3.setProvider(new Web3.providers.HttpProvider('http://192.168.1.121:22005'));
  await web3_4.setProvider(new Web3.providers.HttpProvider('http://192.168.1.121:22006'));


	for (var i = 0; i <2; i++) {
		if (i > 0) await new Promise(r => setTimeout(r, 1000));
		for (var j = 0; j < 200; j++) {
			await web3_2.eth.contract(abi_Query).new("organization 2", "John Doe", {
				gas: 500000,
				gasPrice: 0,
				from: "0xe87FB3b01557CCCFD0375973A331E212D3532719",
				data: '0x' + bytecode.object,
				privateFor: ["cTq/Sd5hO3NUtCSJBqgHltSLryCn3y2oha3YgXGIUEU=", "YKNzi8JfD1pSQyCM5Lsh2YOoJVPFwFLoo/1EJuY9EG8=", "Bt55dfENcZN1tldsqD/OjIKaQ3WEYV0qYlySGP3051Q=", "L2w5WP4tADjYKA0B2If1t60nVstvUY6vUSj3SLhisQc="]
			}, (error, result) => {
				if (error != null) {
					console.log(error);
				}
			});
			await web3_3.eth.contract(abi_Query).new("organization 3", "John Doe", {
				gas: 500000,
				gasPrice: 0,
				from: "0x1dEb272eECfbe0f4A0cd66f6A1FcA7fAa54e33c0",
				data: '0x' + bytecode.object,
				privateFor: ["cTq/Sd5hO3NUtCSJBqgHltSLryCn3y2oha3YgXGIUEU=", "YKNzi8JfD1pSQyCM5Lsh2YOoJVPFwFLoo/1EJuY9EG8=", "Bt55dfENcZN1tldsqD/OjIKaQ3WEYV0qYlySGP3051Q=", "L2w5WP4tADjYKA0B2If1t60nVstvUY6vUSj3SLhisQc="]
			}, (error, result) => {
			});
			await web3_4.eth.contract(abi_Query).new("organization 1", "John Doe", {
				gas: 500000,
				gasPrice: 0,
				from: "0x5636602f92C0461b606DC53a7811f0c6d4784eA4",
				data: '0x' + bytecode.object,
				privateFor: ["cTq/Sd5hO3NUtCSJBqgHltSLryCn3y2oha3YgXGIUEU=", "YKNzi8JfD1pSQyCM5Lsh2YOoJVPFwFLoo/1EJuY9EG8=", "Bt55dfENcZN1tldsqD/OjIKaQ3WEYV0qYlySGP3051Q=", "L2w5WP4tADjYKA0B2If1t60nVstvUY6vUSj3SLhisQc="]
			}, (error, result) => {
			});
...
var testPrivateOnlyTwo = async function() {
	const Web3 = require('../app/node_modules/web3');
	...
	for (var i = 0; i <2; i++) {
		...
		for (var j = 0; j < 200; j++) {
			await web3_2.eth.contract(abi_Query).new("organization 2", "John Doe", {
				...
				from: "0xe87FB3b01557CCCFD0375973A331E212D3532719",
				data: '0x' + bytecode.object,
				privateFor: ["cTq/Sd5hO3NUtCSJBqgHltSLryCn3y2oha3YgXGIUEU=", "YKNzi8JfD1pSQyCM5Lsh2YOoJVPFwFLoo/1EJuY9EG8="]
			}, (error, result) => {
				if (error != null) {
					console.log(error);
				}
...
var unlockAccounts = async function() {
	const Web3 = require('../app/node_modules/web3');
	...
	web3_2.personal.unlockAccount("0xe87FB3b01557CCCFD0375973A331E212D3532719", "node4abc1", 0); //this is just for demo purpose
	web3_3.personal.unlockAccount("0x1dEb272eECfbe0f4A0cd66f6A1FcA7fAa54e33c0", "node5abc1", 0); //this is just for demo purpose
	web3_4.personal.unlockAccount("0x5636602f92C0461b606DC53a7811f0c6d4784eA4", "node6abc0", 0); //this is just for demo purpose
	console.log("done");

}

var lockAccounts = async function() {
	const Web3 = require('../app/node_modules/web3');
	...
	web3_2.personal.lockAccount("0xe87FB3b01557CCCFD0375973A331E212D3532719");
	web3_3.personal.lockAccount("0x1dEb272eECfbe0f4A0cd66f6A1FcA7fAa54e33c0");
	web3_4.personal.lockAccount("0x5636602f92C0461b606DC53a7811f0c6d4784eA4");
	console.log("done");
}

var txCount =  async function() {
		const Web3 = require('../app/node_modules/web3');
		...
		await web3_2.setProvider(new Web3.providers.HttpProvider('http://192.168.1.121:22004'));
		var count = 0;
		for (var i = 235683; i <235686; i++) {
			var help = web3_2.eth.getBlockTransactionCount(i);
			count += help;
		}
		console.log(count);
}
