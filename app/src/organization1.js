...
const App = {
    ...
    start: async function() {
        ...
        try {
            ...
            this.aC.checkAccess.call("organization 1", function (error, result){
                console.log(result);
    ...
    query: async function() {
        ...
        this.web3_2 = new Web3();

        await this.web3_2.setProvider(new Web3.providers.HttpProvider(url));
        await this.web3_2.personal.unlockAccount(this.account, password, 3, (error, result) => {
            if(error != null) {
                window.alert(error);
            }
            else {
    ...
    deployContract: async function() {
        var organization = "organization 1";
        ...
        await this.web3_2.eth.contract(abi_Query).new(organization, query, {gas:2000000, gasPrice: 0, from: this.account, data: '0x' + bytecode.object, privateFor: ["cTq/Sd5hO3NUtCSJBqgHltSLryCn3y2oha3YgXGIUEU=", "YKNzi8JfD1pSQyCM5Lsh2YOoJVPFwFLoo/1EJuY9EG8=", "Bt55dfENcZN1tldsqD/OjIKaQ3WEYV0qYlySGP3051Q=", "L2w5WP4tADjYKA0B2If1t60nVstvUY6vUSj3SLhisQc="]}, (error, result) => {
            if(result.address) {
                window.alert("Query done and saved to blockchain! This is only for demostration");
